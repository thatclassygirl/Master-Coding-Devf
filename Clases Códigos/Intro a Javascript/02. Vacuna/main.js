...
var semanasGestacion = 0;

// Paso #2: Validar la primera condición
if (edad >= 18 && fronterizo == true){
    console.log("Si te puedes vacunar, por ser mayor de 18 años y vivir en un municipio fronterizo del Norte");
    ...
    console.log("Lo sentimos, aún no te puedes vaunar, espera próximos avisos");
}